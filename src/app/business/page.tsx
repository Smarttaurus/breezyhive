    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap animate-slide-up">
              <Button href="https://enterprise.breezyhive.com/business/register" size="lg">
                Start Free Trial
              </Button>
          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8 border-4 border-primary relative">
              ...
              <div className="text-center pt-4">
                ...
                <Button href="https://enterprise.breezyhive.com/business/register" size="lg" className="w-full mb-4">
      ...
      <section className="bg-gradient-honey text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button href="https://enterprise.breezyhive.com/business/register" variant="secondary" size="lg">
